...
def feature(a, b):
    ...
    q1_arr, q2_arr = np.array_split(tf_idf.transform(sample).toarray(), 2)
...
q1 = "what is current capital of Pakistan"
q2 = "what is the capital of India"


grid = pickle.load(open('grid.pkl', 'rb'))
pred = grid.predict_proba(feature(q1, q2))[:, 1]
print(pred)

print("Similar") if pred>0.5 else print("Unique")
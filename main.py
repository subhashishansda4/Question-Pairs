...
def process_batch(x):
    ...
    final_df = df_new.drop(columns=['id', 'qid1', 'qid2', 'question1', 'question2', 'is_duplicate'])
    # --------------------------------------------------
    ...
    final_df['is_duplicate'] = df_new['is_duplicate']
    x = final_df
    # ---------------------------------------------------
    return x
...
# common words
sns.displot(df_new[df_new['is_duplicate'] == 0]['word_common'], label='no')
sns.displot(df_new[df_new['is_duplicate'] == 1]['word_common'], label='yes')
plt.legend()
plt.show()

# total words
sns.displot(df_new[df_new['is_duplicate'] == 0]['word_total'], label='no')
sns.displot(df_new[df_new['is_duplicate'] == 1]['word_total'], label='yes')
plt.legend()
plt.show()

# total common
sns.displot(df_new[df_new['is_duplicate'] == 0]['common_total'], label='no')
sns.displot(df_new[df_new['is_duplicate'] == 1]['common_total'], label='yes')
plt.legend()
plt.show()

# words shared
sns.displot(df_new[df_new['is_duplicate'] == 0]['word_share'], label='no')
sns.displot(df_new[df_new['is_duplicate'] == 1]['word_share'], label='yes')
plt.legend()
plt.show()
# --------------------------------------------------
